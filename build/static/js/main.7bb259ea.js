!(function(e) {
  ...
  function(e, t, n) {
    ...
    function k(e) {
      var t = tr;
      (tr = null),
        t && (e ? y(t, v) : y(t, b), tr && r("95"), Kn.rethrowCaughtError());
    }
    function E(e) {
      if (e[ar]) return e[ar];
      for (var t = []; !e[ar]; ) {
    ...
    function L(e, t, n, r) {
      if (n && r)
        e: {
          for (var o = n, a = r, i = 0, l = o; l; l = S(l)) i++;
          l = 0;
    ...
    function G(e, t) {
      switch (e) {
        ...
        case "topTextInput":
          return (e = t.data), e === Cr && kr ? null : e;
        default:
          return null;
      }
    }
    ...
    function X() {
      if (Sr) {
        var e = Sr,
          t = Pr;
        if (((Pr = Sr = null), Q(e), t)) for (e = 0; e < t.length; e++) Q(t[e]);
      }
    }
    function Z(e, t) {
      return e(t);
    ...
    function pe(e) {
      "value" === e.propertyName &&
        ce(Lr) &&
        ((e = le(Lr, e, te(e))), J(ue, e));
    }
    function de(e, t, n) {
      "topFocus" === e
        ? (fe(), (Dr = t), (Lr = n), Dr.attachEvent("onpropertychange", pe))
        : "topBlur" === e && fe();
    }
    function he(e) {
    ...
    function je(e, t) {
      ...
      return (
        ...
        ro && Tn(ro, n)
          ? null
          : ((ro = n),
            (e = j.getPooled(eo.select, no, e, t)),
            (e.type = "select"),
            (e.target = to),
            D(e),
            e)
      ...
      return {
        ...
        mountClassInstance: function(e, t) {
          ...
          (o.props = l),
            ...
            "function" === typeof o.componentWillMount &&
              ...
              null !== (a = e.updateQueue) && (o.state = Ct(n, e, a, o, l, t))),
        ...
        updateClassInstance: function(e, t, a) {
          ...
          if (
            ...
            (s = t.memoizedState),
            (a = null !== t.updateQueue ? Ct(e, t, t.updateQueue, l, c, a) : s),
            !(
              u !== c ||
              s !== a ||
              mo.current ||
    ...
    function St(e) {
      ...
      function v(a, l, u, c) {
        ...
        for (
          var f = (s = null), p = l, d = (l = 0), g = null, v = u.next();
          null !== p && !v.done;
          d++, v = u.next()
        ) {
      ...
      return function(e, o, i, u) {
        ...
        if ((c && _t(e, i), "undefined" === typeof i))
          switch (e.tag) {
            case 2:
            case 1:
            ...
            t.tag)) {
              ...
              case 6:
                if (e && null != t.stateNode) w(e, t, e.memoizedProps, s);
                  ...
                  (e = f()),
                    (n = d()),
                    g(t) ? y(t) && o(t) : (t.stateNode = i(s, e, n, t));
                }
                return null;
              case 7:
    ...
    function At(e) {
      function t(e) {
        ...
        for (W(), t.current = e, J = n; null !== J; ) {
          ...
          try {
            for (; null !== J; ) {
              var c = J.effectTag;
              if ((36 & c && M(J.alternate, J), 128 & c && U(J), 64 & c))
                switch (((a = J),
                (i = void 0),
                null !== ee &&
                  ((i = ee.get(a)),
      ...
      function i(e) {
        if (null !== ee) {
          if (!(0 === Z || Z > e))
            if (Z <= G) for (; null !== Y; ) Y = c(Y) ? a(Y) : o(Y);
            else for (; null !== Y && !x(); ) Y = c(Y) ? a(Y) : o(Y);
        } else if (!(0 === Z || Z > e))
          if (Z <= G) for (; null !== Y; ) Y = o(Y);
      ...
      function p(e) {
        return 0 !== $
          ? $
          : Q ? (ae ? 1 : Z) : !V || 1 & e.internalContextTag ? f() : 1;
      }
      function d(e, t) {
        return h(e, t, !1);
      }
              ...
              : "topCancel" === o
                ...
                : "topClose" === o
                  ? (ne("close", !0) && Ie("topClose", "close", e),
                    (n.topClose = !0))
                  : Qr.hasOwnProperty(o) && Ne(o, Qr[o], e),
          (n[o] = !0));
      }
    }
    function ln(e, t, n, r) {
        ...
        "style" === i
          ...
          : "dangerouslySetInnerHTML" === i
            ...
            : "children" === i
              ? tn(e, l)
              : r
                ? null != l ? Ut(e, i, l) : e.removeAttribute(i)
                : null != l ? Mt(e, i, l) : jt(e, i);
      }
      switch (n) {
        case "input":
          Vt(e, o);
      ...
      Tr = {
        ...
        extractEvents: function(e, t, n, r) {
          ...
          return (
            a
              ? (wr &&
                  (Er || a !== xr.compositionStart
                    ? a === xr.compositionEnd && Er && (o = M())
              ...
              : (o = null),
            (e = br ? G(e, n) : $(e, n))
              ? ((t = K.getPooled(xr.beforeInput, t, n, r)), (t.data = e), D(t))
              : (t = null),
            [o, t]
          );
        }
    ...
    j.augmentClass(ge, { view: null, detail: null });
    var Ur = {
      Alt: "altKey",
      Control: "ctrlKey",
      Meta: "metaKey",
    ...
    (Kr = function(e, t, n, r) {
      ...
      (Zn = lr.getFiberCurrentPropsFromNode),
      (Jn = lr.getInstanceFromNode),
    ...
    if (wn.canUseDOM)
      if (
        ...
        var qo = function(e) {
          ...
          var t = e - zo + Ko;
          t < Ko && Vo < Ko
            ? (8 > t && (t = 8), (Ko = t < Vo ? Vo : t))
            : (Vo = t),
            (zo = e + Ko),
            jo || ((jo = !0), window.postMessage(Wo, "*"));
        };
        (Lo = function(e, t) {
          return (
            (Uo = e),
        ...
        (Lo = window.requestIdleCallback), (Fo = window.cancelIdleCallback);
    else
      (Lo = function(e) {
    ...
    var ia = null,
      ...
      ua = Ro({
        ...
        prepareForCommit: function() {
          ...
          (la = { focusedElem: e, selectionRange: t }), Oe(!1);
        },
    ...
    var i = n(1),
      ...
      f = (function(e) {
        function t(e) {
          ...
          return (
            (n.handleClickUpdate = function(e) {
              var t = n.state,
                r = t.api,
                o = t.value;
              r.field.setValue(o);
  ...
  function(e, t, n) {
    ...
    var a = n(28),
                  ...
                  switch ((e.prev = e.next)) {
                    ...
                    case 2:
                      return e.abrupt("return", {
                        entity: {
                          fields: {
                            name: { "en-US": "Knowit Developer Summit 2023" }
                          }
                        }
                      });
                    case 3:
      ...
      null),
      u = function(e) {
        (window.contentfulExtension || window.contentfulWidget).init(function(
          t
        ) {
          (l = t), e(t);
        });
  ...
  function(e, t, n) {
    ...
    if (((r.regeneratorRuntime = void 0), (e.exports = n(30)), o))
      ...
      function c(e, t, n) {
        ...
        return function(a, i) {
          ...
          for (n.method = a, n.arg = i; ; ) {
            ...
            var c = r(e, t, n);
            if ("normal" === c.type) {
              if (((o = n.done ? P : _), c.arg === O)) continue;
...
//# sourceMappingURL=main.7bb259ea.js.map
